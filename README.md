...
- Screenshots are all in `/screenshots` (https://github.com/aazard/Cyber-Security-Base-2025_Project_I/tree/main/screenshots). Flaw is displayed, Soloutions are provided
